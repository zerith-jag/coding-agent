...
from ml_classifier_service.main import app
...
class TestClassificationAPI:
    ...
    def test_classify_bug_fix(self, client):
        ...
        request = {
            "task_description": "Fix the critical login bug affecting all users"
        }
    ...
    def test_classify_response_schema(self, client):
        ...
        required_fields = [
            ...
            "reasoning", "suggested_strategy", "estimated_tokens"
        ]
