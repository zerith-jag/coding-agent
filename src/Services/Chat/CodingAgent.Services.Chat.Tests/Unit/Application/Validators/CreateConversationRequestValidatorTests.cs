...
public class CreateConversationRequestValidatorTests
{
    private readonly CreateConversationRequestValidator _validator = new();

    [Fact]
    public void Should_Pass_When_Title_Is_Valid()
    {
        // Arrange
        var request = new CreateConversationRequest("Valid Title");
    ...
    public void Should_Fail_When_Title_Exceeds_200_Characters()
    {
        ...
        var request = new CreateConversationRequest(longTitle);
    ...
    {
        // Arrange
        var request = new CreateConversationRequest("a");
